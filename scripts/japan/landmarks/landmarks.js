    ...
    <dialog class="content__landmarks dialog">
      <ul>
        <span class="thumbnail"> 
          ...
          <span>
            <img src="${landmarks.image_1}" alt="${landmarks.alt_text_1}" />
            <br>
        ...
        <span class="thumbnail"> 
          ...
          <span>
            <img src="${landmarks.image_2}" alt="${landmarks.alt_text_2}" />
            <br>
        ...
        <span class="thumbnail"> 
          ...
          <span>
            <img src="${landmarks.image_3}" alt="${landmarks.alt_text_3}" />
            <br>
